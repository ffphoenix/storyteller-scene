...
import { AddSceneObjectCommand } from '../impl/addSceneObject.command';
import { ModifySceneObjectCommand } from '../impl/modifySceneObject.command';
import { DeleteSceneObjectCommand } from '../impl/deleteSceneObject.command';
